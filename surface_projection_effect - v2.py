...
def build_projection_tree(ng):
    ...
    # phi_angle is the output of this node

    # 3. Calculate ring radius and height from angle (Spherical Coordinates)
    # r = SphereRadius * sin(phi)
    # z = SphereRadius * cos(phi)
    ...
    # The normal is the normalized position vector of the points on the ring.
    ring_point_pos = new_node(nodes, 'GeometryNodeInputPosition', location=(0, 300))
