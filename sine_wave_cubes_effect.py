# Blender 4.4 - "Sine Wave Cubes Effect" Geometry Nodes Script
# Projects an expanding circle of cubes onto a sphere, with a traveling sine wave modulating their height.
...
def build_sine_wave_cubes_tree(ng):
    ...
    map_angle = new_node(nodes, 'ShaderNodeMapRange', location=(-1400, 100))
